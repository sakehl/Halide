...
@*/
int par_seq_mem(struct halide_buffer_int32_t *_input_buffer, struct halide_buffer_int32_t *_out_buffer) {
 ...
 {
  /*@
   loop_invariant 0 <= _out_s0_x && _out_s0_x <= 0 + 100;
   loop_invariant (\forall* int _0, int _1; 0 <= _0 && _0 < 42 && 0 <= _1 && _1 < 100; Perm(&_input_buffer->host[_1*42 + _0], 84));
   loop_invariant (\forall* int _out_s0_x_forall; 0 <= _out_s0_x_forall && _out_s0_x_forall < 100; Perm(&_out[_out_s0_y*100 + _out_s0_x_forall], 1\1));
  @*/
