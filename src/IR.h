...
struct Predicate: public ExprNode<Predicate> {
    ...
    static Expr make(const std::string &name, const std::vector<Expr> &args, Expr perm, const std::vector<Type> &buffer_types, PredicateType pred_type);
...
struct Load : public ExprNode<Load> {
    ...
    static Expr make(Type type, const std::string &name,
                     ...
                     Parameter param,
                     Expr predicate,
                     ModulusRemainder alignment, Expr lemma);
...
struct Store : public StmtNode<Store> {
    ...
    static Stmt make(const std::string &name, Expr value, Expr index,
                     Parameter param, Expr predicate, ModulusRemainder alignment, Expr lemma);
