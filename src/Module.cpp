...
LoweredFunc::LoweredFunc(const std::string &name,
    ...
    : name(name), args(args), body(std::move(body)), linkage(linkage), name_mangling(name_mangling), annotations(annotations) {
}
...
LoweredFunc::LoweredFunc(const std::string &name,
                         ...
                         NameMangling name_mangling,
                         std::vector<Annotation> annotations)
    : name(name), body(std::move(body)), linkage(linkage), name_mangling(name_mangling), annotations(annotations) {
